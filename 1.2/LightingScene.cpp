...
/*
void LightingScene::toggleSomething(int angle, int rx, int ry, int rz, int sentido){
	...
	co=sin((double)robot->getAngle()*rad);
	ca=cos(rad*(double)robot->getAngle());
